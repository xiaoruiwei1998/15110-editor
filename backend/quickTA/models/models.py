...
class GPTModel(models.Model):
    ...
    model_header_name = models.TextField(max_length=1000, default="")
    model_preheader_name = models.TextField(max_length=1000, default="")
    model_header_information = models.TextField(max_length=1000, default="")

    # Advanced Model Settings
    enableNewConversation = models.BooleanField(default=False)
    enableEvaluationResults = models.BooleanField(default=False)
    enableNotes = models.BooleanField(default=False)
    enableTTS = models.BooleanField(default=False)
    enableSTT = models.BooleanField(default=False)
    enableGuardrails = models.BooleanField(default=False)
    enableInstructorFeedback = models.BooleanField(default=False)
    ...
    # Others
    guardrails = models.BooleanField(default=False)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['_id'], name='model_id_idx'),
            models.Index(fields=['model_name'], name='model_name_idx'),
            models.Index(fields=['course_id'], name='model_course_id_idx'),
        ]
